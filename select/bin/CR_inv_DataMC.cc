...
int main(int argc,char* argv[])
{
	...
	get_lumi_weight( Weights_map , "/wk_cms2/cychuang/CMSSW_9_4_13/src/TopCPViolation/full_sel/full_16_CR_inv_new.txt" );
	...
	get_path( Data_Set_Path , "/wk_cms2/cychuang/CMSSW_9_4_13/src/TopCPViolation/full_sel/full_16_CR_inv_new.txt" );
	...
	string new_file_name = training_name + string("_invCRmass_") + time_str + ".root";
