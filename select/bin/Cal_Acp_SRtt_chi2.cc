...
*/
			...
			for(int entry=0;entry<(int)t_entries;++entry)
			{
				...
				cout << "j1 : " << sel.Idx_J1() << " Pt : " << j1.Pt() << endl;
				cout << "j2 : " << sel.Idx_J2() << " Pt : " << j2.Pt() << endl;
	...
	string new_file_name = string("chi2_SRttAcp_") + time_str + ".root";
