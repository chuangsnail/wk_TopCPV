 ...
 *	Usage : {exe} {mva/chi2} {algo_cut} {Mlb cut(1/0)} {test/mormal} {change-info #}	
 *
 * ********************************/
...
int main(int argc,char* argv[])
{
	...
	if( is_Mlb_cut )
		...
		Mlb_text = "Mlb-No";
	string sample_path = "/wk_cms2/cychuang/CMSSW_9_4_13/src/TopCPViolation/fake_data_" + training_name + "_" + Mlb_text + "/";
	string new_file_name = sample_path + training_name + string("_ChangeInfo_Sample-") + to_string( change_number ) + ".root";
