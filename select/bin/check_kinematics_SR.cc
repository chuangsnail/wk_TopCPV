...
int main(int argc,char* argv[])
{
	...
	//*** make histograms ***//
	Hists hists;
	hists.SetAxisInfo( " ;Leading Jet Eta;Events[No.]", "" );
	//hists.SetBinInfo( 50, 0., 200. );	//for Pt
...
*/
		...
		ofstream f;
		f.open( "/wk_cms2/cychuang/CMSSW_9_4_13/src/TopCPViolation/information/SR_kinematics.txt",fstream::app );		
	...
	string new_file_name = string("check_LJetEta_SR_") + time_str + ".root";
